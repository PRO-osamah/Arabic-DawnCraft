...
public enum QuestNPC implements StringRepresentable {
	...
	CULT_INFORMER(QuestEntities.QUEST_PLAYER.get(), "{\"username\":\"PRO_osamah\", \"quest\":\"dawncraft:cult\"}"),
	...
	SAGE(QuestEntities.QUEST_PLAYER.get(), "{\"username\":\"GeniusMohammed\", \"quest\":\"dawncraft:sage\"}\"}"),
